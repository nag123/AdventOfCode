...
object TrebuchetPart2 extends App {
  ...
  val part2 = input.map(CalculatedcalibrationValue(_, """one|two|three|four|five|six|seven|eight|nine|\d""".r))

  println("The sum is "+part2)
}